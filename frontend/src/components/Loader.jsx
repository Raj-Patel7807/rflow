...
export default function Loader({ message = "Connecting to services..." }) {
    ...
    useEffect(() => {
        ...
        if (seconds >= 60) {
            setStatusText(
                "Almost there! The server is taking a little longer than usual to wake up.",
            );
        } else if (seconds >= 40) {
            setStatusText(
                "Render is waking up the server. First requests may take up to a minute.",
            );
        } else if (seconds >= 27) {
        ...
        <div className="loader-overlay">
            <div className="loader-container">
                ...
                <div className="loader-text-wrapper">
                    ...
                    {seconds > 5 && (
                        <span className="loader-time-elapsed">
                            Elapsed: {seconds}s
                        </span>
                    )}
                </div>
